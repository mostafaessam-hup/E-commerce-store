            ...
            <div class="row">
                <div class="col-12 col-sm-6">
                    ...
                    <div class="col-12 product-image-thumbs">
                        <div class="product-image-thumb active"><img src="{{asset($product->image)}}"
                                alt="Product Image"></div>
                        <div class="product-image-thumb"><img src="{{asset('assets/img/prod-2.jpg')}}"
                                alt="Product Image"></div>
                        <div class="product-image-thumb"><img src="{{asset('assets/img/prod-3.jpg')}}"
                                alt="Product Image"></div>
                        <div class="product-image-thumb"><img src="{{asset('assets/img/prod-4.jpg')}}"
                                alt="Product Image"></div>
                        <div class="product-image-thumb"><img src="{{asset('assets/img/prod-5.jpg')}}"
                                alt="Product Image"></div>
                    </div>
                </div>
                <div class="col-12 col-sm-6">
                    ...
                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                        ...
                        <label class="btn btn-default text-center">
                            ...
                            {{-- <input type="radio" name="color_option" id="color_option_b1" autocomplete="off">
                            <span class="text-xl"> {{$product->size}}
                            </span>
                            <br>
                            Small--}}
                        </label>
